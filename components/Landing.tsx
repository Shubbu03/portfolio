		...
		<div className="w-full max-w-2xl mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16 flex flex-col items-center">
			...
			<div className="mb-8 text-start w-full max-w-2xl">
				...
				<p className="text-sm sm:text-base text-gray-700 dark:text-gray-300">
					Building on Solana with Rust, focused on on-chain programs, protocol
					design, and performance-driven systems. Learning by shipping, breaking
					things, and refining the details.<b>Superteam India Memeber.</b>
				</p>
			</div>
