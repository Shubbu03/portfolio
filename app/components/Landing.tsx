...
export default function Landing() {
  return (
    <div className="w-full max-w-2xl mx-auto px-4 py-16 flex flex-col items-center">
      ...
      <div className="mb-8 w-full max-w-2xl">
        ...
        <ul className="text-base text-gray-700 dark:text-gray-300">
          <li className="mb-1">
            ...
            <span className="text-xs text-gray-400">Nov 2024 - May 2025</span>
          </li>
        </ul>
      </div>
      <div className="mb-8 w-full">
        ...
        <ul className="text-base text-gray-700 dark:text-gray-300">
          <li>
            ...
            <span className="text-xs text-gray-400">2020 - 2024</span>
          </li>
        </ul>
      </div>
      <div className="mb-8 w-full">
        ...
        <div className="flex flex-wrap gap-3">
          {[
            ...
            <span
              key={skill}
              className="px-3 py-1 bg-gray-200 dark:bg-gray-800 rounded-full text-sm text-gray-800 dark:text-gray-200 hover:bg-blue-100 dark:hover:bg-blue-900 hover:scale-110 hover:shadow-lg transition-all duration-300 cursor-pointer"
            >
              {skill}
            </span>
          ))}
